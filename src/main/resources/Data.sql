insert into expenseUser values (1,'Siamak', 'Codeengine11@gmail.com')
insert into expenseUser values (2,'John', 'John@john.com')
insert into expenseUser values (3,'Adam', 'adam@adam.com')
